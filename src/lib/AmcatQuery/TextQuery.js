...
import { TextArea, Form, Modal, Dropdown, Button } from "semantic-ui-react";
// Be sure to include styles at some point, probably during your bootstrapping

export default function TextQuery({ queryString, setQueryString }) {
  return (
    <Form fluid style={{ marginBottom: "2em", width: "100%" }}>
      <TextArea
        ...
        value={queryString}
        placeholder="Query..."
        onChange={(e, d) => setQueryString(d.value)}
      />
      <QueryHelp />
    </Form>
  );
